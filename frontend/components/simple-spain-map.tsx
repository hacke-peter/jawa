...
export function SimpleSpainMap() {
  ...
  >('humidity');
  const [activeMap, setActiveMap] = useState('destination-map');
  ...
  return (
    <>
      <Tabs value={activeMap} onValueChange={setActiveMap}>
        <TabsList className="">
          <TabsTrigger key={'destination-map'} value={'destination-map'}>
            {'Destinations Map'}
          </TabsTrigger>
          <TabsTrigger key={'pollution-map'} value={'pollution-map'}>
            {'Pollution Map'}
          </TabsTrigger>
        </TabsList>
        <TabsContent value="destination-map" style={{ height: '450px' }}>
          <MapChart />
        </TabsContent>
        <TabsContent value="pollution-map" style={{ height: '450px' }}>
          <Image
            src={`/heatmap_${currentMonth + 1}.png`}
                ...
                <ol className="ml-6 list-decimal space-y-2">
                  {condition === 'respiratory' ? (
                    <>
                      ...
                      <li className="text-sm">
                        <span className="font-medium">Madrid</span> - Low
                        humidity in summer, but avoid extreme heat
                      </li>
                      <li className="text-sm">
                    ...
                    <>
                      ...
                      <li className="text-sm">
                        ...
                        Excellent healthcare and moderate climate
                      </li>
                      <li className="text-sm">
                        <span className="font-medium">Canary Islands</span> -
                    ...
                    <>
                      <li className="text-sm">
                        <span className="font-medium">Canary Islands</span> -
                        Low pollen counts and consistent climate
                      </li>
                      <li className="text-sm">
